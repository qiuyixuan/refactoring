...
class Game:
    ...
    def game_loop(self):
        ...
        if self.ball.xcor() < -(self.border-10) and self.ball.xcor() > -self.border and self.ball.ycor() < self.paddle_1.ycor() + 50 and self.ball.ycor() > self.paddle_1.ycor() - 50:
            self.collision(-(self.border-10))
        elif self.ball.xcor() > self.border-10 and self.ball.xcor() < self.border and self.ball.ycor() < self.paddle_2.ycor() + 50 and self.ball.ycor() > self.paddle_2.ycor() - 50:
            self.collision(self.border-10)
